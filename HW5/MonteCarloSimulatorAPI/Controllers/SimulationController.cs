...
namespace MonteCarloSimulatorAPI.Controllers
{
    ...
    public class SimulationController : ControllerBase
    {
        ...
        public ActionResult<SimulationResult> PriceOption([FromBody] OptionParameters parameters)
        {
            ...
            {
                randomNumbers = new VanDerCorputGenerator(parameters.Simulations, parameters.Steps, parameters.Base1, parameters.Base2).RandomNumbers;
            }
            else
            {
                randomNumbers = new RandomNumberGenerator(parameters.Simulations, parameters.Steps, parameters.Antithetic).RandomNumbers;
            }
