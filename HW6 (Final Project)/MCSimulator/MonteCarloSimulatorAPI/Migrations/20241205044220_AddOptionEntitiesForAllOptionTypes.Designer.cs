...
namespace MonteCarloSimulatorAPI.Migrations
{
    ...
    [Migration("20241205044220_AddOptionEntitiesForAllOptionTypes")]
    partial class AddOptionEntitiesForAllOptionTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MonteCarloSimulatorAPI.Models.AsianOptionEntity", b =>
                {
                    b.HasBaseType("MonteCarloSimulatorAPI.Models.OptionEntity");

                    b.ToTable("AsianOptionEntities", (string)null);
                });
            ...
            modelBuilder.Entity("MonteCarloSimulatorAPI.Models.LookbackOptionEntity", b =>
                {
                    b.HasBaseType("MonteCarloSimulatorAPI.Models.OptionEntity");

                    b.ToTable("LookbackOptionEntities", (string)null);
                });

            modelBuilder.Entity("MonteCarloSimulatorAPI.Models.RangeOptionEntity", b =>
                {
                    b.HasBaseType("MonteCarloSimulatorAPI.Models.OptionEntity");

                    b.ToTable("RangeOptionEntities", (string)null);
                });
            ...
            modelBuilder.Entity("MonteCarloSimulatorAPI.Models.AsianOptionEntity", b =>
                {
                    b.HasOne("MonteCarloSimulatorAPI.Models.OptionEntity", null)
                        .WithOne()
                        .HasForeignKey("MonteCarloSimulatorAPI.Models.AsianOptionEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MonteCarloSimulatorAPI.Models.LookbackOptionEntity", b =>
                {
                    b.HasOne("MonteCarloSimulatorAPI.Models.OptionEntity", null)
                        .WithOne()
                        .HasForeignKey("MonteCarloSimulatorAPI.Models.LookbackOptionEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MonteCarloSimulatorAPI.Models.RangeOptionEntity", b =>
                {
                    b.HasOne("MonteCarloSimulatorAPI.Models.OptionEntity", null)
                        .WithOne()
                        .HasForeignKey("MonteCarloSimulatorAPI.Models.RangeOptionEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
